...
import b8one_bg from "../images/jm__about_b8one.png";
...
import b8one from "../images/jm__employer--b8one.png";
...
const employers = [
  {
    ...
    description: (
      <>
        Fullstack E-Commerce development using{" "}
        <SimpleLink external to="//vtex.io">
          VTEX IO
        </SimpleLink>{" "}
        in a Serverless development environment using mostly ReactJS
        (ES6/Typescript), NodeJS (Koa.js), GraphQL, Tachyons on an open-source
  ...
  },
  {
    ...
    bg: outgreen_bg,
    description:
      "Fullstack Development and Web Design building websites using Wordpress, jQuery, grid-systems, HTML5 and CSS.",
  },
];
...
export const About = () => (
  <article className="w-100 flex flex-column flex-wrap items-center">
    <header className="w-100 tc mb5">
      ...
      <p className="lh-copy">
        These are some of the awesome places where I've worked. <br />
        You can also check my{" "}
        <SimpleLink external to="//linkedin.com/in/hellojuliomoreira">
          LinkedIn
        </SimpleLink>{" "}
    ...
    {employers.map(({ slug, image, name, tagline, description, bg }) => (
      <section
        key={slug}
        className={`w-100 mb5 flex flex-column justify-end black`}
      >
        <div
          className="cover"
          style={{
        ...
        <div className="w-100 ph3 pv3 items-center flex flex-column">
          <div className="mw8 center tc">
            <p>
              <img src={image} alt="" className="mw-100 mw4 br-100" />
            </p>
            <h3 className="lh-copy f3 fw4">{name}</h3>
            <h5 className="dib ph3 pv2 ma0 lh-copy f5 fw5 mono bb bt bl-0 br-0 b--solid b--near-white">
              {tagline}
            </h5>
